...
<script>
    ...
    export default defineComponent({
        ...
        setup(props, ctx) {
            ...
            const createCropper = () => {
                // props.cropperOptions 是cropper的选项参数
            ...
            onMounted(() => {
                ...
                // https://github.com/overtrue/vue-avatar-cropper-demo/blob/master/src/components/Avatar.vue
                ...
                fileInput.addEventListener('change', () => {
                    ...
                    if (fileInput.files != null && fileInput.files[0] != null) {
                        ...
                        // console.log("文件名称----> ", filename.value)
                        mimeType.value = mimeType.value || fileInput.files[0].type // 文件元类型
                        // console.log("文件元类型---> ", mimeType.value)
                        // 告诉 cropper 已经提交过了 
